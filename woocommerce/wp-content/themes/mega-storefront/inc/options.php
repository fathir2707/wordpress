...
add_filter('ecommerce_plus_default_theme_options', 'mega_storefront_default_settings');

function mega_storefront_default_settings($ecommerce_plus_default_options){
		
		
	$ecommerce_plus_default_options['primary_color'] = '#1987e8';
	$ecommerce_plus_default_options['accent_color'] = '#43b033';
	...
	$ecommerce_plus_default_options['topbar_login_label'] = esc_html__('Contact', 'mega-storefront');
